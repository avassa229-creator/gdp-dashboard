...
def stream_assistant_reply(user_input: str, prenom: str = None, history: list = None):
    """Génère la réponse de Floreina avec Groq via des requêtes HTTP brutes (Évite l'erreur 405)."""
    ...
    # Construction des messages au format Groq
    ...
    # Appel direct de l'API REST de Groq
    url = "https://groq.com"
    headers = {
    ...
    payload = {
        ...
        "messages": messages,
        "temperature": 0.7,
        "stream": True  # On active l'affichage mot par mot
    }
    ...
    try:
        ...
        # Découpage du flux streaming reçu de Groq
